...
feature 'Visitor see most favorited recipes' do
  scenario 'succesfully' do
    ...
    recipe = create(:recipe, title: 'receita1', user: user, cuisine: cuisine,
                             recipe_type: recipe_type)
    recipe2 = create(:recipe, title: 'receita2', user: user, cuisine: cuisine2,
                              recipe_type: recipe_type2)
    recipe3 = create(:recipe, title: 'receita3', user: user, cuisine: cuisine3,
                              recipe_type: recipe_type3)
    recipe4 = create(:recipe, title: 'receita4', user: user, cuisine: cuisine4,
                              recipe_type: recipe_type4)
    recipe5 = create(:recipe, title: 'receita5', user: user, cuisine: cuisine5,
                              recipe_type: recipe_type5)
